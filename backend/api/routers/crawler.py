...
from backend.data_layer.crawler_overview import get_crawlable_tables
...
def list_tables() -> list[dict]:
    ...
    Pure orchestration (v8 §6): the router does NOT touch PostgreSQL. The
    actual SELECT-only read happens in backend.data_layer.crawler_overview.
    """
    return get_crawlable_tables()
